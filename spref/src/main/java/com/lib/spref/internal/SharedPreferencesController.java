...
public abstract class SharedPreferencesController {
	 ...
	 */
	protected SharedPreferencesController(Context context, String name, MergeType mergeType, int resource) {
		mPreferences = context.getSharedPreferences(name, Context.MODE_PRIVATE);
		if(resource != Utils.INVALID_ID) {
			MergeUtils.merge(context, mergeType, resource, mPreferences);
		}
	}
